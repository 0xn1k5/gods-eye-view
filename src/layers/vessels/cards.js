import { accentForVesselType, normalizeVesselType } from '../../data/vesselLabels.js';

export function createCards({ vesselState, services, parts: components, layer, options }) {
...
return { updateSelectedVesselHud, resetSelectedVesselHud, trimHudValue, buildVesselCard, buildSelectedVesselCard, vesselOverlayEntryId, vesselTypeShort, cardScreenSeparated, displayVesselName, formatSpeed, formatHeading, formatPositionTime };
}
