...
Object.assign(layer, parts.queries.methods, parts.lifecycle.methods, parts.ingestion.methods);
layer.source = source?.label || 'Vessels';
Object.assign(layer, { applyVesselFocusDeemphasis: parts.rendering.applyVesselFocusDeemphasis, buildVesselCard: parts.cards.buildVesselCard, buildSelectedVesselCard: parts.cards.buildSelectedVesselCard, cardScreenSeparated: parts.cards.cardScreenSeparated });
Object.defineProperty(layer, 'testing', { value: parts.testing });
return layer;
}
export { AIS_FIRST_CONNECT_GRACE_MS } from './policy.js';
export {
  VESSEL_OVERLAY_SOURCE_ID, VESSEL_LABEL_GRID_PX, VESSEL_DEFAULT_LABEL_LIMIT,
  VESSEL_OVERLAY_MAX_COHORT, VESSEL_CARD_FADE_DISTANCE_M, normalizeVesselType,
  vesselTypeCss, accentForVesselType, vesselOverlayCohortLimit, applyVesselOverlayPolicy,
